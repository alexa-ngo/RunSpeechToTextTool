...
printf("THERE IS A 96 BYTES between here and in the heap there is about 100 something\n");
printf("It is between 177  and 203 before the else!");
...
printf("There is an issue above this: ^");
            } else {
